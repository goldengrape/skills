...
Run [Validate Generated Course OKF](validate-generated-course-okf.md). This now has two layers:
...
If the quality gate fails, run [Repair Generated Course OKF](repair-generated-course-okf.md), then rerun [Evaluate Generated Course OKF](evaluate-generated-course-okf.md). Do not return `validation_result.passed=true` until both structural validation and content quality pass.
